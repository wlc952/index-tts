...
def gen_single(prompt, text, max_text_tokens_per_sentence=80, *args):
    output_path = None
    if not output_path:
        output_path = os.path.join("outputs", f"spk_{int(time.time())}.wav")
    top_p, top_k, temperature, repetition_penalty = args
    kwargs = {
...
<a href='https://arxiv.org/abs/2502.05512'><img src='https://img.shields.io/badge/ArXiv-2502.05512-red'></a>
    ...
    with gr.Tab("音频生成"):
        ...
        with gr.Accordion("高级生成参数设置", open=False):
                ...
                with gr.Column(scale=2):
                    ...
                    with gr.Row():
                        max_text_tokens_per_sentence = gr.Slider(
                            label="分句最大Token数", value=80, minimum=20, maximum=120
                        )
            ...
            advanced_params = [top_p, top_k, temperature, repetition_penalty]
